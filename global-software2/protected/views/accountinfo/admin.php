			...
			<fieldset>
				<div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		...
                		<div class="col-md-8"><label>Global Auto Transportation</label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
			...
			<fieldset>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		...
                		<div class="col-md-7"><label>Global Auto Transportation</label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		<div class="col-md-5"><label>Dispatch Contact: </label></div>
                		<div class="col-md-7"><label><?php echo $model->dispatch_contact; ?></label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		<div class="col-md-5"><label>Owner or Manager: </label></div>
                		<div class="col-md-7"><label><?php echo $model->owner; ?></label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		<div class="col-md-12"><label>Address: </label></div>
                		<div class="col-md-12"><label><?php echo $model->address; ?><br/><?php echo $model->city; ?>, <?php echo $model->state; ?> <?php echo $model->zip; ?></label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		<div class="col-md-5"><label>Phone to List: </label></div>
                		<div class="col-md-7"><label><?php echo $model->phone_local; ?></label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		<div class="col-md-5"><label>Fax: </label></div>
                		<div class="col-md-7"><label><?php echo $model->fax; ?></label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 5px;">
                	<div class="col-md-12">
                		<div class="col-md-5"><label>Email: </label></div>
                		<div class="col-md-7"><label><?php echo $model->email; ?></label></div>
                	</div>
                </div>
                <div class="row" style="padding-bottom: 10px;">
                	<div class="col-md-12">
                		<div class="col-md-5"><label>ICC-MC Number: </label></div>
                		<div class="col-md-7"><label><?php echo $model->mc_number; ?></label></div>
                	</div>
                </div>
			</fieldset>
		</div>
