    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#menu5">Not Signed
                (<?php echo $model->search(GlobalTrackerDispatch::$enumStatus['not_signed'], $pageSize)->getTotalItemCount(); ?>)</a></li>
            
             <!-- <li><a data-toggle="tab" href="#menu7">Issues
                (<?php // echo $model->search(GlobalTrackerDispatch::$enumStatus['issues'], $pageSize)->getTotalItemCount(); ?>)</a></li>
            <li><a data-toggle="tab" href="#menu2">Hold
                (<?php // echo $model->search(GlobalTrackerDispatch::$enumStatus['hold'], $pageSize)->getTotalItemCount(); ?>)</a></li>
            <li><a data-toggle="tab" href="#menu3">Archived 
                (<?php // echo $model->search(GlobalTrackerDispatch::$enumStatus['archived'], $pageSize)->getTotalItemCount(); ?>)</a></li> -->
        ...
        <div class="tab-content">
            ...
            <div id="menu2" class="tab-pane fade">
                <?php $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'dataProvider' => $model->search(GlobalTrackerDispatch::$enumStatus['hold'], $pageSize),
                    'filter'=>$model,
                    'columns'=>array(
                        array(
                            'class' => 'CCheckBoxColumn',
            ...
            <div id="menu3" class="tab-pane fade">
                <?php $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'dataProvider' => $model->search(GlobalTrackerDispatch::$enumStatus['archived'], $pageSize),
                    'filter'=>$model,
                    'columns'=>array(
                        array(
                            'class' => 'CCheckBoxColumn',
            ...
            <div id="menu5" class="tab-pane fade">
                <?php $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'dataProvider'=>$model->search(GlobalTrackerDispatch::$enumStatus['not_signed'], $pageSize),
                    'filter'=>$model,
                    'columns'=>array(
                        array(
                            'class' => 'CCheckBoxColumn',
            ...
            <div id="menu7" class="tab-pane fade">
                <?php $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'dataProvider' => $model->search(GlobalTrackerDispatch::$enumStatus['issues'], $pageSize),
                    'filter'=>$model,
                    'columns'=>array(
                        array(
                            'class' => 'CCheckBoxColumn',
...
$(document).ready(function() {
    ...
    $("#pagen").change(function() {
        ...
        sleep(300);
        var path = '<?php echo Yii::app()->createurl('dispatch/admin',array('click'=>'__clicked__'))?>';
...
/*function moveTohold() {
    ...
    window.location.href = '<?php //echo Yii::app()->createurl('dispatch/admin', array('click' => 'menu2'))?>';
}*/
...
function moveToUser() {
    ...
    $('input[type=checkbox]:checked').each(function(index, val) {
        ...
        //console.log($(val).attr('value'));
        var idVal = $(val).attr('value');
        var url = '<?php echo Yii::app()->createUrl('dispatch/changeUser', array('id' => '__id__', 'username' => '__username__'));?>';
        url = url.replace('__id__', idVal);
...
/*function moveToArchive() {
    ...
    window.location.href = '<?php //echo Yii::app()->createurl('dispatch/admin', array('click' => 'menu3'))?>';
}
...
function searchText() {
    ...
    var url='<?php echo Yii::app()->createUrl('dispatch/admin',array('__searchQ__'=>'__sbox__','click'=>'__click__')); ?>';
...
function resetSearch() {
    ...
    var url='<?php echo Yii::app()->createUrl('dispatch/admin',array('click'=>'__click__')); ?>';
    url = url.replace('__click__',ctab);
    window.location.href = url;
}
