...
<div class="row" style="margin:0 auto; width: 80%; border: #ccc solid 1px;">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-sm-4"><h4 class="bold grayFont">Quote #<?php echo '&nbsp;'. FilingGenerics::showQuoteId($model->id); ?></h4></div>
        </div>
        <hr>
        <div class="row">
            <div class="col-sm-5">
                <p class="top-head">Global Auto Transportation</p>
            ...
            <div class="col-sm-7">
                ...
                <div class="col-sm-6 text-right"> Email: </div><div class="col-sm-6"><a href="malto:<?php echo '&nbsp;'. $model->email;?>"><?php echo '&nbsp;'. FilingGenerics::breakEmail($model->email);?></a></div>
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="col-sm-12">Once again, thank you for the opportunity to serve your automobile transport needs. This is your quote receipt.<br /><span class="bold">Please review the information below and contact us immediately with any corrections.</span></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
               ...
               <!-- <div class="row">
                    <div class="col-sm-5 text-right">Balance Paid By : </div><div class="col-sm-5 brd-btm"><?php /*echo '&nbsp;'. GlobalTrackerQuote::$enumPaidBy[$model->bal_paid_by]; */?></div>
                </div>-->
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-5 text-right">Ship Via : </div><div class="col-sm-5 brd-btm"><?php echo  GlobalTrackerQuote::$enumShipVia[$model->s_via]; ?></div>
                </div>
                <div class="row">
                    <div class="col-sm-5 text-right">Vehicle(s) Run : </div><div class="col-sm-5 brd-btm"><?php echo  GlobalTrackerQuote::$arrVRun[$model->s_vrun]; ?></div>
                </div>
            </div>
        </div>
        ...
        <ul>
            <li>For all quotes placed through Global Auto Transport, a minimum of $100.00 deposit is required depending on the size and condition of the vehicle.</li>
            <li>The deposit placed through Global Auto Transport is refundable to shipper in the event the shipper cancels the quote and at the time of cancellation no carrier had been assigned to that quote.</li>
