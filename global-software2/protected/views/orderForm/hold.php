...
<div class="row">
    <div class="col-lg-12">
        <span><a style="float: right;" class="btn btn-success" href="<?php echo Yii::app()->createUrl('orderForm/create');?>"><i class="fa fa-add"></i> Create Order</a></span>
    </div>
</div>
...
<a id="cancelBtn" onclick="moveToCancel();" class="btn btn-info"
           style="margin:10px;float: right;"><i
                    class="fa fa-stop"></i> Move to Cancel</a>
...
<script>
    ...
    function moveToOrder() {
        ...
        $('input[type=checkbox]:checked').each(function (index, val) {
            ...
            var url = 'index.php?r=orderForm/movetoorder&id=__id__';
        ...
        alert("Move succeed!");
        window.location.href = 'index.php?r=orderForm/hold';
    }
    ...
    function moveToCancel() {
        $('input[type=checkbox]:checked').each(function (index, val) {
            ...
            console.log($(val).attr('value'));
            var idVal = $(val).attr('value');
            var url = 'index.php?r=orderForm/movetocancel&id=__id__';
            url = url.replace('__id__', idVal);
            //alert(url);
            $.ajax({
                type: "GET",
    ...
    function searchText()
    {
     ...
     //   var ctab=$('.nav-tabs').find('li[class="active"] a').attr('href');
      //  ctab=ctab.replace('#','');
        ...
        var url='<?php echo Yii::app()->createUrl('orderForm/index',array('__searchQ__'=>'__sbox__')); ?>';
    ...
    {//var ctab=$('.nav-tabs').find('li[class="active"] a').attr('href');
       // ctab=ctab.replace('#','');
        ...
        var url='<?php echo Yii::app()->createUrl('orderForm/index'); ?>';
       // url = url.replace('__click__',ctab);
