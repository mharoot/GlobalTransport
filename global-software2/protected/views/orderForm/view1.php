    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <div class="row">
                    <div class="col-sm-5 text-right">Balance Paid By : </div><div class="small col-sm-5 brd-btm"><?php //echo GlobalTrackerOrder::$enumPaidBy[$model->bal_paid_by]; ?></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-5 text-right">Ship Via : </div><div class="col-sm-5 brd-btm"><?php echo GlobalTrackerOrder::$enumShipVia[$model->s_via]; ?></div>
                </div>
                <div class="row">
                    <div class="col-sm-5 text-right">Vehicle(s) Run : </div><div class="col-sm-5 brd-btm"><?php echo GlobalTrackerOrder::$arrVRun[$model->s_vrun]; ?></div>
                </div>
            </div>
        </div>
