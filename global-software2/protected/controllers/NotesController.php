...
class NotesController extends Controller
{
	...
	public function insertHistoryQ($id, $field, $old, $new, $created_by) {
    ...
    public function insertHistoryO($id, $field, $old, $new, $created_by) {
		date_default_timezone_set('America/Los_Angeles');
        $curTime = date("Y-m-d H:i:s");
    ...
    public function actionUpdateAjax() {
        ...
        if(empty($_POST)) {
            ...
            if($notes->validate()) {
                ...
                $model=GlobalTrackerOrder::model()->findByAttributes(array('quote_id'=>$notes->quote_id));
                //if($model === null) {
                if(!empty($model)) {
                	$this->insertHistoryO($model->id, 'Internal Notes', 'none', $notes->note, $notes->created_by);
                } else {
                	$this->insertHistoryQ($notes->quote_id, 'Internal Notes', 'none', $notes->note, $notes->created_by);
            	}
            } else {
                $success = false;
