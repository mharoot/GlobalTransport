...
class OrderFormController extends Controller {
    ...
    /*public function actionConvert($quote_id) {
        $quote = GlobalTrackerQuote::model()->findByPk($quote_id);
        ...
        $this->render('quoteForm/initialQuote', array(
            'model' => $model,
        ));
    }*/
    ...
    public function actionSaveScr() {
        ...
        if(file_put_contents($file,$imagedata)) {
            $CreditCardAuth->signature='uploadsign/'.$filename.'.png';
