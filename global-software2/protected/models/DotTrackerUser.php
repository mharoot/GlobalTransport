...
/**
 * This is the model class for table "global_tracker_user".
 *
 * The followings are the available columns in table 'global_tracker_user':
 * @property integer $id
...
class DotTrackerUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            //array('creationdatetime','default', 'value'=>new CDbExpression('NOW()'), 'setOnEmpty'=>true,'on'=>'insert'),
			array('active, role, pageSize', 'numerical', 'integerOnly'=>true),
			array('lname, extra, phone, last_updated, stime, etime, pageSize', 'safe'),
            //array('s_password', 'compare', 'compareAttribute'=>'password' , 'on'=>'insert, update'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, fname, lname, extra, phone, username, email, active, creationdatetime, last_updated, password, role, stime, etime, pageSize', 'safe', 'on'=>'search'),
		);
	}
