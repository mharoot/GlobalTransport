                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if(!empty($model->s_vrun) && array_key_exists($model->s_vrun,GlobalTrackerOrder::$arrVRun))
                                        {
                                            echo GlobalTrackerOrder::$arrVRun[$model->s_vrun];
                                        }
                                        else{
                                            echo '--';
                                        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if(!empty($model->s_via) && array_key_exists($model->s_via,GlobalTrackerOrder::$enumShipVia))
                                        {
                                            echo GlobalTrackerOrder::$enumShipVia[$model->s_via];
                                        }
                                        else{
                                            echo '--';
                                        }
                    ...
                    <div class="panel-body">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <?php if(!empty($model->referred_by) && array_key_exists($model->referred_by,GlobalTrackerOrder::$enumReferBy))
                                    {
                                        echo GlobalTrackerOrder::$enumReferBy[$model->referred_by];
                                    }
                                    else{
                                        echo '--';
                                    }?>
        ...
        function onSaveclick(){
            ...
            html2canvas($("#signBoard"), {
                onrendered: function(canvas) {
                    ...
                    var sendUrl= '<?php echo $this->createUrl('/orderForm/saveScr',array('id'=>$model->id)); ?>';
                    $.ajax({
                        type:'POST',
                        url: sendUrl,
