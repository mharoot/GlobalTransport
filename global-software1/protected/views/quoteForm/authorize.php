    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12" style="margin-bottom: 10px;">
                <center><img src="http://www.globalautotransportation.com/wp-content/themes/global%20auto%20transportation/images/logo2.png" class="img img-responsive"><h2 style=" ">quote FORM (quote# : <?php echo FilingGenerics::showQuoteId($model->id); ?>) </h2></center>
