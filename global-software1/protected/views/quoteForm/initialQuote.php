...
<div class="row" style="width:80%;">
	<div class="col-sm-12" style="display:inline-block;">
		<input type="checkbox" id="" name="" onclick="enableSubmit()">
...
<?php echo CHtml::submitButton($model->isNewRecord ? 'Submit' : 'Submit',array('id'=>'subBtn','style'=>'margin-left:400px;', 'name'=>'but1','class'=>'btn btn-success')); ?>
<hr>
<?php $this->endWidget(); ?>
