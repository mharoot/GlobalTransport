...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="?r=dispatch/update&id=<?php echo $model->id; ?>">Edit Order</a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo $form->dropDownList($model,'s_vrun',GlobalTrackerDispatch::$arrVRun,array('class'=>'form-control','prompt'=>'Select one')); ?>

                                        </div>

                                        <div class="form-group">
                                            <label for="nameon_card">Ship Via <span style="color: red">*</span></label>
                                            <?php echo $form->dropDownList($model,'s_via',GlobalTrackerDispatch::$enumShipVia,array('class'=>'form-control','prompt'=>'Select one')); ?>
                        ...
                        <div class="panel-body">
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <?php echo $form->dropDownList($model,'referred_by',GlobalTrackerDispatch::$enumReferBy,array('class'=>'form-control','prompt'=>'Select one')); ?>
...
<script>
    ...
    function moveTo(status) {
        ...
        if(status === 'order') {
           var url = '<?php echo Yii::app()->createUrl('dispatch/changeStatus', array('id' => '__id__', 'status' => FilingGenerics::encryptKey(GlobalTrackerDispatch::$enumStatus['order'])));?>';
        } else if(status === 'not_signed') {
            window.location.href = '<?php echo Yii::app()->createurl('dispatch/dispatch&id='.$model->id.'&status=5'); ?>';
            //var url = '<?php //echo Yii::app()->createUrl('dispatch/changeStatus', array('id' => '__id__', 'status' => FilingGenerics::encryptKey(GlobalTrackerDispatch::$enumStatus['not_signed'])));?>';
        } else if(status === 'dispatched') {
            window.location.href = '<?php echo Yii::app()->createurl('dispatch/dispatch&id='.$model->id.'&status=6'); ?>';
            //var url = '<?php //echo Yii::app()->createUrl('dispatch/changeStatus', array('id' => '__id__', 'status' => FilingGenerics::encryptKey(GlobalTrackerDispatch::$enumStatus['dispatched'])));?>';
        } else if(status === 'issues') {
            var url = '<?php echo Yii::app()->createUrl('dispatch/changeStatus', array('id' => '__id__', 'status' => FilingGenerics::encryptKey(GlobalTrackerDispatch::$enumStatus['issues'])));?>';
        } else if(status === 'hold') {
            var url = '<?php echo Yii::app()->createUrl('dispatch/changeStatus', array('id' => '__id__', 'status' => FilingGenerics::encryptKey(GlobalTrackerDispatch::$enumStatus['hold'])));?>';
        } else if(status === 'archived') {
            var url = '<?php echo Yii::app()->createUrl('dispatch/changeStatus', array('id' => '__id__', 'status' => FilingGenerics::encryptKey(GlobalTrackerDispatch::$enumStatus['archived'])));?>';
        }
        ...
        /*if(status === 'dispatched') {
            window.location.href = '<?php //echo Yii::app()->createurl('dispatch/dispatch&id='.$model->id); ?>';
        } else if(status === 'not_signed') {
            window.location.href = '<?php //echo Yii::app()->createurl('dispatch/dispatch&id='.$model->id); ?>';
        }*/
    }
