...
<div class="row" style="margin-top:30px;">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="?r=dispatch/view&id=<?php echo $model->id; ?>">Order Detail</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <span><?php echo $model->cod_method;//echo GlobalTrackerDispatch::$enumCodMethod[$model->cod_method]; ?></span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
    ...
    <div class="col-md-3 noprint" style="float:right;">
        <div class="list-group">
            ...
            <a href="<?php echo Yii::app()->createUrl('dispatch/create'); ?>" target="_blank" class="list-group-item"><i class="fa fa-eye" aria-hidden="true"></i>
                &nbsp;Create Order </a>
            <a href="<?php echo Yii::app()->createUrl('dispatch/admin'); ?>" class="list-group-item"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;&nbsp;Manage Orders</a>
            <a href="<?php echo Yii::app()->createUrl('dispatch/update',array('id'=>$model->id)); ?>" class="list-group-item"><i class="fa fa-pencil" aria-hidden="true"></i> Update Orders</a>
            <a href="<?php echo Yii::app()->createUrl('dispatch/authorizeSignature',array('id'=>$model->id)); ?>" class="list-group-item"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;&nbsp;Authorize Order</a>

            <a target="_blank" href="<?php echo Yii::app()->createUrl('dispatch/orderReceipt',array('id'=>$model->id)); ?>" class="list-group-item"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;&nbsp;Print Order Receipt</a>
            <a style="display: none;" href="<?php echo Yii::app()->createUrl('dispatch/shipperInvoice',array('id'=>$model->id)); ?>" class="list-group-item"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;&nbsp;Print Shipper Invoice</a>
        </div>
    </div>
</div>
