    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12" style="margin-bottom: 10px;">
                <center><img src="http://www.globalautotransportation.com/wp-content/themes/global%20auto%20transportation/images/logo2.png" class="img img-responsive"><h2 style=" ">ORDER FORM (ORDER# : <?php echo FilingGenerics::showOrderId($model->id); ?>) </h2></center>
            ...
            <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if(!empty($model->s_vrun) && array_key_exists($model->s_vrun,GlobalTrackerDispatch::$arrVRun))
                                        {
                                            echo GlobalTrackerDispatch::$arrVRun[$model->s_vrun];
                                        }
                                        else{
                                            echo '--';
                                        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if(!empty($model->s_via) && array_key_exists($model->s_via,GlobalTrackerDispatch::$enumShipVia))
                                        {
                                            echo GlobalTrackerDispatch::$enumShipVia[$model->s_via];
                                        }
                                        else{
                                            echo '--';
                                        }
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="">
                        <?php echo FilingGenerics::getVehicleInfo($model->id); ?>
                    ...
                    <div class="panel-body">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <?php if(!empty($model->referred_by) && array_key_exists($model->referred_by,GlobalTrackerDispatch::$enumReferBy))
                                    {
                                        echo GlobalTrackerDispatch::$enumReferBy[$model->referred_by];
                                    }
                                    else{
                                        echo '--';
                                    }?>
        ...
        function onSaveclick(){
            ...
            html2canvas($("#signBoard"), {
                onrendered: function(canvas) {
                    ...
                    var sendUrl= '<?php echo $this->createUrl('/dispatch/saveScr',array('id'=>$model->id)); ?>';
                    $.ajax({
                        type:'POST',
                        url: sendUrl,
