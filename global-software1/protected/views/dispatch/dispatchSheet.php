        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="row adjustMargin">
                    ...
                    <div class="col-lg-4 brd-btm" style="display:inline-block; width:150px;"><?php echo GlobalTrackerDispatch::$enumShipVia[$model->s_via]; ?></div>
                    <div class="col-lg-2" style="display:inline-block; width:200px;">Vehicles Run:</div>
                    <div class="col-lg-4 brd-btm" style="display:inline-block; width:110px;"><?php echo GlobalTrackerDispatch::$arrVRun[$model->s_vrun]; ?></div>
                </div>
            </div>
