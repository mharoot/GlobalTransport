...
$twilio_phone_number = "7868286862"; 
...
$client->messages->create(
    ...
    array(
        ...
        "body" => "Credit Card Authorization request has been generated , Click on the link to authenticate http://globalautotransportation.software/index.php?r=orderForm/authorizeSignature&id=".$argv[1]
    )
);
